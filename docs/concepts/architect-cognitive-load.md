# The Architect's Cognitive Load Problem (and why AI makes it both worse and better)

*A practical guide to WIP limits, task management, and preparing for AI-assisted architecture work*

You know the feeling. You're an enterprise architect. You have 47 open tabs, 12 "urgent" emails, three architecture reviews due this week, a strategy document that's been "nearly done" for a month, and someone just messaged you on Teams or Slack about a new AI initiative that needs an architecture positioning paper by Friday.

You're not lazy. You're not disorganised. You're just drowning in open loops.

And here's the uncomfortable truth: it's about to get worse. The volume of information, decisions, and documentation demands on architects is accelerating. AI is simultaneously the cause (more tools, more possibilities, more "could we just turn on this AI feature...?" requests) and the cure, if you know how to wield it that is.

I'm an enterprise architect leading the AI Platform strategy for a regional sized bank. I have over 40 years' experience in the IT industry and over 30 years' experience with AI and machine learning, since researching neural networks at PhD level in the early 1990s before leaving to co-found a venture-capital-backed AI startup focused on time series prediction.

Here we talk about the science of why you feel overwhelmed, the surprisingly simple fix, and how to prepare for a future where AI agents do a significant chunk of your architecture work, but only if you've built the scaffolding first.

## Your brain has a hard limit (and you're likely exceeding it)

Let's start with what cognitive science actually tells us.
...
Now think about your typical day. How many concurrent things or thread are you managing? Architecture reviews, vendor evaluations, strategy documents, team mentoring, stakeholder management, that proof of concept someone started and never finished and so on.
...
The numbers vary, but the principle is consistent: deliberately constraining your active commitments is not a limitation. It is a force multiplier. You finish things faster, think more clearly, and, counterintuitively, get more done.

### Little's law: the mathematical proof

This isn't just psychology. It's mathematics. Little's Law, from queuing theory, states:

> **Lead Time = Work in Progress / Throughput**

If your throughput (completion rate) is roughly constant, and for knowledge work, it is, then halving your WIP halves the time it takes to complete each item. Starting fewer things means finishing things faster. Every architect who has ever wondered why their initiatives drag on for months should look at how many they're running concurrently.
...
This is the one that matters most for architects. How many architecture initiatives -- strategy documents, reference architectures, vendor evaluations, proofs of concept etc. are you actively progressing? If the answer is more than three, you're paying Newport's overhead tax and getting diminishing returns on all of them.

The discipline is simple: divide your work into three named initiatives that you're intentionally and actively driving toward an outcome, plus and a pseudo initiative to cover "everything else". Everything else is real work e.g. your manager asks you to review something, a stakeholder needs a quick assessment, there's a team meeting, someone pings you about a production issue. It never stops. But by separating it from your three focus initiatives, every task you pick up forces a conscious question: "Is this progressing one of my three outcomes, or is it reactive?"

This isn't about refusing reactive work. Your manager or key stakeholder asks, you do it. But you're aware of the trade-off. You're choosing with intention rather than drifting through the day responding to whoever made the more noise.
...
Everything. Because AI agents are about to become your colleagues, and they need the same kind of structure, arguably more.

### The problem AI creates

AI tools are incredible accelerators. I use Claude Code daily for architecture documentation, research synthesis, code generation, and analysis. But they also create a new failure mode: **you can start things faster than ever, which means you can have more things in progress than ever.**
...
Here's what I've learned from building and using AI agent workflows: an AI agent with a vague brief produces vague output. An AI agent with a structured work item -- clear scope, defined activities, specific tasks, explicit deliverables -- produces work that genuinely accelerates you.

This is why I've been developing an open-source framework called **AI-Assisted Architecture** ([github.com/dermot-obrien/ai-assisted-architecture](https://github.com/dermot-obrien/ai-assisted-architecture)). It provides:

**A structured methodology** that breaks architecture work into phases (Enterprise Context, Capability Modelling, Building Blocks, Solution Design, Governance), each with defined AI roles and human review gates.

**A work management system** where work items decompose into activities and tasks -- machine-readable, version-controlled, and designed for both human and AI execution:

```
Work Item (Epic)
  └── Activity (Story) — the unit of assignment
        └── Task — sequential steps
              └── Deliverable — concrete output
```

**Governance built in**, not bolted on. Every AI-generated artefact carries provenance metadata (ai-raw, ai-curated, draft) so you always know what's been reviewed and what hasn't. This aligns with emerging standards around the EU AI Act and content provenance.
...
The framework is opinionated by design. It works with Claude Code, GitHub Copilot, Cursor, or any AI tool -- because the structure lives in your repository, not in a proprietary platform.

### What this looks like in practice

Here's a concrete example. I needed a comprehensive research report on WIP limits and cognitive load -- the very research that underpins this article. In the old world, that's several days of reading papers, synthesising findings, and writing up recommendations.

Instead, I:

1. Created a work item (WI-017) with a research activity
2. Defined the specific questions I wanted answered
...
That's the pattern. **You think. You scope. You decide. The agent researches, drafts, and documents.** Your WIP stays at three initiatives because the agent is handling the throughput bottleneck within each one.
...
**Within 3-5 years**, AI agents will handle significant portions of solution design work -- pattern selection, building block composition, integration design. The architect's role will shift further toward governance, stakeholder alignment, and the genuinely creative decisions that require organisational context and judgment.

**The architects who thrive** will be those who have built the scaffolding: structured methodologies, clear work decomposition, governance frameworks, and the discipline to limit their own WIP so they can think clearly about the things that matter.

**The architects who struggle** will be those who tried to use AI as a faster way to do the same chaotic, overcommitted, context-switching work they do today. AI amplifies your working pattern. If your pattern is scattered, AI gives you scattered output faster.
...
2. **This Sunday**, do a weekly review. List the 15 tasks for next week. Pick which three initiatives they serve. If you have more than three active initiatives, park one. It will still be there when you're ready.

3. **Apply the rule**: nothing new goes on until something comes off.

4. **When you're ready to explore AI augmentation**, look at structured frameworks that give agents clear scope, deliverables, and governance. The [AI-Assisted Architecture](https://github.com/dermot-obrien/ai-assisted-architecture) framework is one option -- open source, designed for enterprise architects, and built to work with whatever AI tools you prefer.
...
*Dermot O'Brien is an enterprise architect leading the AI Platform target state architecture and roadmap for a New Zealand based regional sized bank. He is also building open-source frameworks for AI-assisted architecture work and participates in communities dedicated to AI infrastructure for "second brain". His AI-Assisted Architecture framework is available at [github.com/dermot-obrien/ai-assisted-architecture](https://github.com/dermot-obrien/ai-assisted-architecture).*
