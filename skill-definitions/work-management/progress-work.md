...
1. **Load workflow agent rules**: Read `.ai-assisted-work/skill-definitions/{workflow-path}/AGENTS.md` (e.g. `.../image-management/AGENTS.md`)
2. **Load workflow documentation**: Read `.ai-assisted-work/skill-definitions/{workflow-path}.md` or the workflow doc in that folder (e.g. `.../image-management/replace-ascii-diagrams.md`)
...
2. Read .ai-assisted-work/skill-definitions/{workflow}/AGENTS.md → Load agent rules
...
1. **Load agent rules**: Read `.ai-assisted-work/skill-definitions/image-management/AGENTS.md`
2. **Load workflow doc**: Read `.ai-assisted-work/skill-definitions/image-management/replace-ascii-diagrams.md`
