# {WI-NNN} {Title} - AI Agent Addendum
...
> {User's original exact words - preserve verbatim, do NOT paraphrase}
...
|---|----------|--------|-----------|
| 1 | {Question asked during scoping} | {User's response} | {Why this question matters} |
| 2 | {Another question} | {User's response} | {Why this question matters} |

### Additional Refinements

{Document any additional refinements made through continued dialogue, including context that helps explain why certain decisions were made.}

### Synthesized Intent

The final refined instruction that combines all inputs:

> {Comprehensive statement of intent that incorporates the original instruction and all clarifications}
...
4. **Scope boundaries**: Strictly exclude:
   - {Item excluded per clarifying questions}
   - {Another exclusion}

5. **Phase awareness**: 
   - {Any phased approach notes}
   - Don't conflate phases.

### Key Concepts to Understand

| Concept | Definition | Key Point |
|---------|------------|-----------|
| {Concept 1} | {Definition} | {Important detail} |
| {Concept 2} | {Definition} | {Important detail} |

### Related Workspace Artifacts

When working on this item, reference these existing artifacts:

- `{path/to/artifact}` - {What context it provides}
- `{path/to/another}` - {What context it provides}
...
| Date | Change | Author |
|------|--------|--------|
| {YYYY-MM-DD} | Initial addendum created from scoping session | AI Agent |
